...
re = /\w/; // Word character - alphanumeric or _ ( try "!3xx!fg(" )
re = /\w+/; // + means one or more
re = /\W/; // Non-word characters ie anything but alphanumeric or _
re = /\W+/; // // + means one or more
re = /\d/; // Match any digit
re = /\d+/; // + means one or more
re = /\D/; // Match any non-digit (Any not 0 through 9)
re = /\D+/; // + means one or more
re = /\s/; // Match whitespace character
re = /\S/; // Match non-whitespace character
re = /Hell\b/i; // Word boundary - "Hello, welcome to Hell" will find match "Hell" and not "Hello"

// Assertions - like conditionals
re = /x(?=yz)/; // Match x only if followed by yz
re = /x(?!y)/; // Match x only if NOT followed by y

// String to match
const str = "xy again xb";
