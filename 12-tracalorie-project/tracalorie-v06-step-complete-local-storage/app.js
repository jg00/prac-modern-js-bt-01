  ...
  return {
    storeItem: function (item) {
      ...
      if (localStorage.getItem("items") === null) {
        ...
        // Load local items array from localstorage
...
const ItemCtrl = (function () {
  ...
  return {
    ...
    updateItem: function (name, calories) {
      ...
      return found; // Item {id: 1, name: "b", calories: 200}
    },
  ...
  return {
    ...
    updateListItem: function (item) {
      ...
      listItems.forEach(function (listItem) {
        const itemID = listItem.getAttribute("id"); // "item-#"
...
const App = (function (ItemCtrl, StorageCtrl, UICtrl) {
  ...
  const itemUpdateSubmit = function (e) {
    ...
    // Update item in data structure and return updated item data
  ...
  // Delete item submit
  const itemDeleteSubmit = function (e, item) {
    // Get current item
